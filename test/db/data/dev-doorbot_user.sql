...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_defaultDoor` FOREIGN KEY (`door_id_user`) REFERENCES `door` (`id`) ON UPDATE CASCADE
...
INSERT INTO `user` VALUES (1,'ccrollin','passwordTest','saltTest',_binary '\0',1);
...
-- Dump completed on 2023-12-01  3:27:49
