...
CREATE TABLE `door` (
  ...
  `doorInfo_id_door` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `displayName` (`displayName`),
  UNIQUE KEY `doorInfo_id_door` (`doorInfo_id_door`),
  KEY `fk_doorInfo_id_door` (`doorInfo_id_door`),
  CONSTRAINT `fk_doorInfo_id_door` FOREIGN KEY (`doorInfo_id_door`) REFERENCES `doorinfo` (`id`) ON UPDATE CASCADE
...
INSERT INTO `door` VALUES (1,'Room 403 Door','Lakeview',1),(2,'Room 300 Door','Plaza',2);
